...
class LoginForm extends State<Login> {
  ...
  Widget build(BuildContext context) {
    var teamNameField = Padding(
        padding: EdgeInsets.all(10.0) + EdgeInsets.only(bottom: 15.0),
        child: TextField(
          controller: teamName,
          onChanged: (s) {
        ...
        child: Scaffold(
            body: Builder(
                builder: (context) => Container(
                    padding:
                        MediaQuery.of(context).padding + EdgeInsets.all(10.0),
                    child: Center(
                        child: Column(
